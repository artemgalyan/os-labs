...
c++ -shared $TEMP_DIR/libvector.o $TEMP_DIR/libnumber.a -o $BUILD_DIR/libvector.so
...
c++ -o $BUILD_DIR/demo_proj $TEMP_DIR/demo_proj.o $TEMP_DIR/libnumber.a $BUILD_DIR/libvector.so
